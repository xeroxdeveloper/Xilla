...
Модули в Xilla базируются на классах и позволяют легко и интуитивно расширять функционал бота. Эта документация описывает процесс их создания для версии **Alpaca B7**.
...
## Генерация Pillow-баннеров (Новинка Alpaca B7)

Начиная с версии Alpaca B7, в ядре Xilla встроен мощный генератор градиентных баннеров для эстетичного ответа. Вы можете использовать его в своих модулях!
