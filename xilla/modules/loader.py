...
class LoaderMod(loader.Module):
    ...
    def __init__(self):
        ...
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "ADDITIONAL_REPOS",
                [
                    "https://github.com/xeroxdeveloper/host/raw/master",
    ...
    async def _async_init(self):
        modules = list(
            filter(
                lambda x: not x.startswith("https://mods.xeroxdeveloper.ru"),
                utils.array_sum(
                    map(
    ...
    async def _get_repo(self, repo: str) -> str:
        ...
        res = type('obj', (object,), {'text': '', 'status_code': 200})()
