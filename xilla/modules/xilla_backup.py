...
class XillaBackupMod(loader.Module):
    ...
    async def client_ready(self):
        if not self.get("period"):
            await self.inline.bot.send_photo(
                self.tg_id,
                photo="https://github.com/xeroxdeveloper/assets/raw/master/unit_alpha.png",
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://github.com/xeroxdeveloper/assets/raw/master/xilla-backups.png",
            _folder="xilla",
        )
    ...
    async def handler(self):
        try:
            ...
            backup.name = (
                f"xilla-db-backup-{datetime.datetime.now():%d-%m-%Y-%H-%M}.json"
            )
