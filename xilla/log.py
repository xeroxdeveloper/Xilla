...
def getlines(filename: str, module_globals=None) -> str:
    ...
    source code of Xilla and Dragon modules properly. This is needed for
    ...
    try:
        if filename.startswith("<") and filename.endswith(">"):
            ...
            if (
                module.startswith("xilla.modules")
                ...
                if isinstance(value, dict):
                    ...
                    try:
                        if (
                            ...
                            value,
                            (xillatl.TelegramClient, CustomTelegramClient),
                        ):
        ...
        async with self._send_lock:
            ...
            self._exc_queue = {
                client_id: [
                    ...
                    for item in self.tg_buff
                    if isinstance(item[0], XillaException)
