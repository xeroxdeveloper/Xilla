...
class Web:
    ...
    def _platform_emoji(self) -> str:
        return {
            "vds": "https://github.com/xeroxdeveloper/assets/raw/master/waning-crescent-moon_1f318.png",
            "lavhost": "https://github.com/xeroxdeveloper/assets/raw/master/victory-hand_270c-fe0f.png",
            "termux": "https://github.com/xeroxdeveloper/assets/raw/master/smiling-face-with-sunglasses_1f60e.png",
            "docker": "https://github.com/xeroxdeveloper/assets/raw/master/spouting-whale_1f433.png",
        }[
            (
                "lavhost"
