...
class PointerList(list):
    ...
    def __init__(self, db: 'Database', module: str, key: str, default: typing.Optional[typing.Any]=None):
        self._db = db
        self._module = module
        self._key = key
    ...
    def __setitem__(self, __i: typing.Union[typing.SupportsIndex, slice], __v: typing.Any) -> None:
