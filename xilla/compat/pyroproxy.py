...
PROXY = {
    pyro_object: xillatl.tl.alltlobjects.tlobjects[constructor_id]
    for constructor_id, pyro_object in raw.all.objects.items()
    if constructor_id in xillatl.tl.alltlobjects.tlobjects
}
REVERSED_PROXY = {
    **{tl_object: pyro_object for pyro_object, tl_object in PROXY.items()},
    **{
        tl_object: raw.all.objects[tl_object.CONSTRUCTOR_ID]
        for _, tl_object in utils.iter_attrs(xillatl.tl.custom)
...
class PyroProxyClient(PyroClient):
    ...
    def __init__(self, tl_client: CustomTelegramClient):
        ...
        super().__init__(
            ...
            lang_code="en",
            in_memory=True,
            phone_number=tl_client.xilla_me.phone,
        )
    ...
    def _on_event(
        self,
        event: typing.Union[
            xillatl.tl.types.Updates,
            xillatl.tl.types.UpdatesCombined,
            xillatl.tl.types.UpdateShort,
        ],
    ):
    ...
    @staticmethod
    def _tl_error2pyro(
        error: xillatl.errors.rpcerrorlist.RPCError,
    ...
    async def resolve_peer(
        ...
        *args,
        **kwargs,
    ) -> "typing.Union[xillapyro.raw.types.PeerChat, xillapyro.raw.types.PeerChannel, xillapyro.raw.types.PeerUser]":  
        """
        ...
        :rtype: typing.Union[xillapyro.raw.types.PeerChat, xillapyro.raw.types.PeerChannel, xillapyro.raw.types.PeerUser]
        """
