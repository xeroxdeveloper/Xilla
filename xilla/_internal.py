...
def get_startup_callback() -> callable:
    return lambda *_: os.execl(sys.executable, sys.executable, '-m', os.path.relpath(os.path.abspath(os.path.dirname(os.path.abspath(__file__)))), *sys.argv[1:])
...
def print_banner(banner: str):
    ...
    with open(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'assets', banner)), 'r') as f:
        print(f.read())